...
protected:
    ...
    map< SkillType, std::shared_ptr<Skill> > skills;
    ...
    void refresh();
    ros::NodeHandle n;    
    ros::Publisher joint_command_publisher[24];    
    void act();
...
public:
    ...
    map< SkillType, std::shared_ptr<Skill> > getSkills()
    {
        return skills;
    }
    void addKeyframeToSkill(SkillType skillIndex, std::shared_ptr<KeyFrame> keyframe);

    void deleteKeyframeFromSkill(SkillType skillIndex, int keyframeIndex);
    void deleteAllKeyframesFromSkill(SkillType skillIndex);

    void editSkill(SkillType skillIndex, int &keyframeIndex, std::shared_ptr<KeyFrame> &newKeyframeData);
