...
private:
    void run();
    ros::NodeHandle nh;        
    ros::ServiceClient client_reset_world;
    ros::ServiceClient client_reset_simulation;
    ros::ServiceClient client_pause_physics;
    ros::ServiceClient client_unpause_physics;
