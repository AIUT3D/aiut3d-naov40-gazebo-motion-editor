...
public:
    ...
    virtual std::shared_ptr<Macro> getReflection(BodyModel *bodyModel) = 0;
...
public:
    ...
    virtual std::shared_ptr<Macro> getReflection(BodyModel *bodyModel);
...
protected:
    ...
    const int legIDX;
    std::shared_ptr<Curve3D> curve;              // XYZ curve, relative to the ball
    std::shared_ptr<Curve3D> rpy_curve;          // RPY curve
...
private:
protected:
    vector< std::shared_ptr<Macro> > macros;
...
public:
    ...
    void appendMacro(std::shared_ptr<Macro> macro);
    ...
    std::shared_ptr<KeyFrame> getReflection(BodyModel *bodyModel);
...
public:
    ...
    void appendKeyFrame( std::shared_ptr<KeyFrame> keyFrame );

    std::shared_ptr<Skill> getReflection(BodyModel *bodyModel);
    ...
    void editKeyframe(const int &keyframeIndex, std::shared_ptr<KeyFrame> &refKeyFrame);
