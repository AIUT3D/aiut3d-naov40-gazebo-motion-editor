...
{
    SkillParser(map< SkillType, std::shared_ptr<Skill> >& skills_, BodyModel* bodyModel_)
...
//                    ID                          ;
        ...
        struct resetCB {
            ...
            resetCB( vector<string>& joints_, std::shared_ptr< KeyFrame >& keyFrame_, SkillParser const& parser_ )
...
//                cerr << *begin << ' ' <<  enumParser.getEnumFromString( *begin );
                ...
                std::shared_ptr< Macro > resetMacro( new Reset( jointIndices ) );
...
//          EnumParser<BodyParts> &enumParser;
        ...
        struct inctarCB {
            ...
            inctarCB( vector<string>& effectors_, vector<double>& effValues_, std::shared_ptr< KeyFrame >& keyFrame_, SkillParser const& parser_ )
...
//                     << '=' << effValues[i] << endl;
                ...
                std::shared_ptr< Macro > inctarMacro( new IncTar( effIndices, effValues ) );
...
//          EnumParser<Effectors> enumParser;
        ...
        struct setscaleCB {
            ...
            setscaleCB( vector<string>& effectors_, vector<double>& effValues_, std::shared_ptr< KeyFrame >& keyFrame_, SkillParser const& parser_ )
                : effectors(effectors_),
                  effValues(effValues_),
                  keyFrame( keyFrame_ ),
                  parser(parser_) {
...
//                     << '=' << effValues[i] << endl;
                ...
                std::shared_ptr< Macro > setscaleMacro( new SetScale( effIndices, effValues ) );
...
//          EnumParser<Effectors> enumParser;
        ...
        struct settarCB
        {
            ...
            settarCB( vector<string>& effectors_, vector<double>& effValues_, std::shared_ptr< KeyFrame >& keyFrame_, SkillParser const& parser_ )
                : effectors(effectors_),
                  effValues(effValues_),
                  keyFrame( keyFrame_ ),
                  parser(parser_)
...
//          EnumParser<Effectors> enumParser;
        ...
        struct setfootCB {
            ...
            setfootCB( string& foot_, vector<double> &pos_, std::shared_ptr< KeyFrame >& keyFrame_, SkillParser const& parser_ )
                : foot(foot_),
                  pos(pos_),
                  keyFrame( keyFrame_ ),
                  parser(parser_) {
...
//              LOG(pos6dof);
                ...
                std::shared_ptr< Macro > setfootMacro( new SetFoot( footIDX, pos6dof ) );
...
//          EnumParser<BodyParts> enumParser;
        ...
        struct stabilizeCB {
            stabilizeCB( string& foot_, vector<double> &pos_, std::shared_ptr< KeyFrame >& keyFrame_, SkillParser const& parser_ )
                : foot(foot_),
                  pos(pos_),
                  keyFrame( keyFrame_ ),
                  parser(parser_) {}
            ...
            void operator() ( iterator_t, iterator_t ) const {
                ...
                std::shared_ptr< Macro > stabilizeMacro(new Stabilize(footIndex, zmp));
        ...
        struct waitCB {
            ...
            waitCB( double& waitTime_, std::shared_ptr< KeyFrame >& keyFrame_, SkillParser const& parser_ )
...
//              cerr << "waitCB(), wait time is " <<  waitTime + 0.0 << endl;
        ...
        struct curveCB {
            ...
            curveCB( const string &foot_, const vector<double> &pos_,
                     std::shared_ptr< KeyFrame > &keyFrame_, SkillParser const &parser_ )
                : foot(foot_), pos(pos_),
            ...
            operator() ( iterator_t, iterator_t ) const {
                ...
                std::shared_ptr< Macro > curveMacro( new Curve( footIDX, controlPoints ) );
...
//          EnumParser<BodyParts> enumParser;
        ...
        struct startSkillCB {
            ...
            operator() ( iterator_t, iterator_t ) const {
                ...
                parser.skills[currentSkillType] =  std::shared_ptr<Skill>( new Skill() );
            }
...
//          EnumParser<SkillType> enumParser;
        ...
        struct startKeyFrameCB {
            ...
            startKeyFrameCB( SkillType& currentSkillType_,
                             std::shared_ptr< KeyFrame >& keyFrame_,
            ...
            operator() ( iterator_t, iterator_t ) const {
                ...
                std::shared_ptr<Skill> currentSkill = parser.skills[currentSkillType];
