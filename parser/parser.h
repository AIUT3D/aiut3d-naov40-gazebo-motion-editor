...
private:
    ...
    vector< std::shared_ptr<VisionObject> > visionObjs;
...
protected:
    ...
    bool parseLine(const string &str, vector< std::shared_ptr<VisionObject> >& visionObjs);
    bool parseGoalPost(const string &str, vector< std::shared_ptr<VisionObject> >& visionObjs);
    bool parseFlag(const string &str, vector< std::shared_ptr<VisionObject> >& visionObjs);
    bool parseBall(const string &str, vector< std::shared_ptr<VisionObject> >& visionObjs);
    bool parsePlayer(const string &str, vector< std::shared_ptr<VisionObject> >& visionObjs);
